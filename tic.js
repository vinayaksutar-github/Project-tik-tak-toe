...
// Checking if player X won or not after
...
else if((b3 =='x'||b3 =='X')&& (b5 =='x'||b5 =='X')&&(b9 =='x'||b9 =='X'))
{
    document.getElementById('print').innerHTML="Player X won";
...
// Checking for player O starts, Is player O won  or not after that disabled all the other fields
...
else if((b3 =='o'||b3 =='O')&& (b5 =='o'||b5 =='O')&&(b9 =='o'||b9 =='O'))
{
    document.getElementById('print').innerHTML="Player X won";
    document.getElementById('b1').disabled=true;
    document.getElementById('b2').disabled=true;
